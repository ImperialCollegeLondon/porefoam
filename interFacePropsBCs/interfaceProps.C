...
Foam::interfaceProps::interfaceProps
(
...
:
#ifndef interfaceProps_interfaceProps // folding hint
  ...
  ( IOobject( "distPointInterface", timeName(), mesh()  ,  IOobject::NO_READ ),//!  WRITE for visualization
    ...
    deltaN_  ("deltaN", 1e-12/cbrt(average(mesh().V())) )
#endif
...
void Foam::interfaceProps::correct(scalar relaxDelS)
{
