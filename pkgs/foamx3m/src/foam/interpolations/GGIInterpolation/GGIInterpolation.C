...
:
	...
	partiallyCoveredMasterAddrPtr_(nullptr),
	masterFaceCoveredFractionsPtr_(nullptr),
	uncoveredSlaveAddrPtr_(nullptr),
	partiallyCoveredSlaveAddrPtr_(nullptr),
	slaveFaceCoveredFractionsPtr_(nullptr)
{
