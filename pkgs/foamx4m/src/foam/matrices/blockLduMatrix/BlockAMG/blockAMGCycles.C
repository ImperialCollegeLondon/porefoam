...
template<>
const char* Foam::NamedEnum<Foam::blockAMGCycleName::cycleType, 3>::names[] =
{
	"V-cycle",
	"W-cycle",
	"F-cycle"
...
const Foam::NamedEnum<Foam::blockAMGCycleName::cycleType, 3>
Foam::blockAMGCycleName::cycleNames_;
